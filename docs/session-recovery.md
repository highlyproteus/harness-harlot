...
Recovery is entirely local and introduces no network access, account, analytics, or telemetry behavior. SSH launch and command-palette behavior are outside this milestone.
